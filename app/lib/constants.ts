...
export const WA_URL =
  "https://api.whatsapp.com/send/?phone=491713457959&text=Hi+Jenny+ich+bin+an+deinen+Leistungen+interessiert&type=phone_number&app_absent=0";
export const INSTAGRAM_URL = "https://www.instagram.com/oooh_my_dog/";
export const PHONE = "+49 171 3457959";
export const PHONE_HREF = "tel:+4917134579599";
