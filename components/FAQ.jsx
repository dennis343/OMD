...
function FAQ() {
  ...
  return (
    <section id="faq" className="sec-pad" style={{ borderBottom: "1px solid var(--line)" }}>
      <div className="shell">
        ...
        <div className="faq-head">
          ...
          <div>
            <h2 className="serif" style={{ fontSize: "clamp(30px, 5vw, 62px)", lineHeight: 1.04, letterSpacing: "-0.02em", fontWeight: 340 }}>
          ...
          {faqs.map((f, i) => {
            ...
            return (
              <div key={i} style={{ borderBottom: "1px solid var(--line-2)" }}>
                ...
                >
                  <span className="serif faq-q" style={{
                ...
                {active && (
                  <div style={{
                    padding: "0 0 28px 0",
                    fontSize: 15.5, lineHeight: 1.6, color: "var(--ink-2)",
                    maxWidth: "72ch",
      ...
      <style>{`
        ...
        .faq-q {
          font-size: 18px; letter-spacing: -0.012em; font-weight: 400;
          line-height: 1.3;
        }
