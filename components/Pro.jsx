// Pro.jsx — Säule 3: Pro & Business — mit "Warum Jenny" + Referenzen
function Pro() {
  const whyJenny = [
    {
      t: "Eigene Premium-Schule",
      d: "Jenny führt selbst eine Hundeschule mit System — vom Kennenlern-Einzel bis zum Signaturprogramm. Keine Theorie, sondern gelebte Praxis.",
    },
    {
      t: "Didaktik + Kommunikation",
      d: "Studium der Erwachsenenbildung und 13 Jahre Führungsarbeit in der Kommunikationsbranche. Jenny kann Fachwissen nicht nur haben, sondern auch vermitteln — an Halter und an Kolleg:innen.",
    },
    {
      t: "Anspruchsvolle Fälle",
      d: "Der Schwerpunkt liegt seit Jahren auf reizoffenen, unsicheren und energiegeladenen Hunden. Jenny lebt selbst mit zwei belgischen Schäferhunden — das prägt das System.",
    },
    {
      t: "System, das skaliert",
      d: "Angebotsarchitektur, Didaktik, Positionierung und Kundenführung — alles ist so gebaut, dass es in anderen Schulen übernommen und angepasst werden kann.",
    },
  ];
  ...
  return (
    <section id="pro" className="sec-pad" style={{ borderBottom: "1px solid var(--line)" }}>
      <div className="shell">
        ...
        <div className="why-jenny">
          <div className="why-jenny-img tile">
            <img src="https://picsum.photos/seed/jenny-pro/900/1100" alt="Jennifer Bakir · Pro-Beratung" loading="lazy" />
        ...
        <div className="pro-grid">
          {modules.map((m, i) => (
            <article key={i} className={`pro-card ${m.featured ? "is-featured" : ""}`}>
              {m.featured && (
                <div className="pro-badge">Hebel</div>
              )}
              ...
              <div className="pro-block" style={{ flex: 1 }}>
                ...
                <ul className="pro-list">
                  {m.includes.map((it, j) => (
                    <li key={j}><span style={{ color: "var(--moss)" }}>+</span> {it}</li>
                  ))}
                </ul>
              </div>

              <a className="btn-link" href="https://api.whatsapp.com/send/?phone=491713457959&text=Hi+Jenny+ich+bin+an+deinen+Leistungen+interessiert&type=phone_number&app_absent=0" target="_blank" rel="noopener" style={{ color: "var(--moss)" }}>
                {m.cta} →
              </a>
            </article>
          ))}
        ...
        <div className="refs-block">
          <div style={{ marginBottom: 32 }}>
            ...
            <h3 className="serif refs-head">
              Keine Behauptungen, sondern Zusammenarbeit.
            </h3>
          </div>
          ...
          <div className="ref-video">
            ...
            <div className="tile ref-video-tile">
              <img src="https://picsum.photos/seed/pro-video/1600/900" alt="Pro Case Lab Video" loading="lazy" />
        ...
        <div className="pro-foot">
          ...
          <a className="btn btn-primary" href="https://api.whatsapp.com/send/?phone=491713457959&text=Hi+Jenny+ich+bin+an+deinen+Leistungen+interessiert&type=phone_number&app_absent=0" target="_blank" rel="noopener" style={{ justifyContent: "center" }}>
            Gespräch per WhatsApp <span className="arrow">→</span>
          </a>
        </div>
      </div>
      ...
      <style>{`
        ...
        .play-icon {
          ...
          color: var(--brass); font-size: 18px; background: rgba(22,19,15,0.4); backdrop-filter: blur(4px);
        }
        ...
        .pro-foot-quote {
          border: 1px solid var(--line-2); padding: 28px 28px;
          background: var(--bg-2);
        }
