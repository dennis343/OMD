// Audience.jsx — "Für wen wir besonders gut sind"
function Audience() {
  const positives = [
  ...
  return (
    <section id="zielgruppe" style={{ padding: "140px 0", background: "var(--bg-2)", borderBottom: "1px solid var(--line)" }}>
      <div className="shell">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 80, marginBottom: 72 }} className="aud-head">
          ...
          <div>
            <h2 className="serif" style={{ fontSize: "clamp(36px, 5.2vw, 68px)", lineHeight: 1.02, letterSpacing: "-0.025em", fontWeight: 340 }}>
            ...
            <ul style={{ listStyle: "none", borderTop: "1px solid var(--line)" }}>
              {positives.map((p, i) => (
                <li key={i} style={{
                  ...
                  display: "flex", gap: 20,
                  fontSize: 15.5, lineHeight: 1.5, color: "var(--ink-2)",
                }}>
            ...
            <ul style={{ listStyle: "none" }}>
              {negatives.map((n, i) => (
                <li key={i} style={{
                  ...
                  fontSize: 14.5, lineHeight: 1.5, color: "var(--ink-3)",
                  display: "flex", gap: 14,
                }}>
                  <span style={{ color: "var(--rust)", fontFamily: "var(--mono)", fontSize: 11, minWidth: 18 }}>×</span>
                  <span>{n}</span>
                </li>
              ))}
            </ul>
